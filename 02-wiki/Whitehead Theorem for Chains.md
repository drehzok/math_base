Prerequisites: [[Chain Complex]], [[Homology]]

# Whitehead Theorem for Chains

## Theorem
Let $\delta: C \to D$ be a quasi-isomorphism (a chain map inducing isomorphisms on homology). If $C$ and $D$ are:
1. Bounded below
2. Degreewise free (or more generally, projective)

then $\delta$ is a **chain homotopy equivalence**.
